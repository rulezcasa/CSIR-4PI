...
wandb.init(project="AT-DQN", name="Pong_v1", config={"total_steps": 20000000, "beta_start":0.4, "beta_end":1.0, "lr":0.00025, "tau":0.45})
...
model_path = "AT_DQN_Models/atdqn_pongv1_model.pth"
