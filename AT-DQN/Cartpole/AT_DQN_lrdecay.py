...
class Agent:
    def __init__(self, state_space, action_space, lr):
        ...
        self.decay_until = config["AT-DQN"]["decay_untill"]
        self.final_lr = config["AT-DQN"]["final_lr"]
        self.initial_lr=lr
        self.new_lr=lr
    ...
    def train_step(self):
        ...
        if self.step_count < self.decay_until:
            self.new_lr = self.initial_lr - (self.initial_lr - self.final_lr) * (self.step_count / self.decay_until)
        else:
            self.new_lr = self.final_lr
